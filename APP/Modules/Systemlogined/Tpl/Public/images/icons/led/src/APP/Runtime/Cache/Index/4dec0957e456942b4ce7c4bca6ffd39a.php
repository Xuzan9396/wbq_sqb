...
<div class="content" id="main_content">
	...
	<div class="buttons-tab">
		...
		<a href="<?php echo U('Index/Emoney/mairu');?>" class=" button">买入IOX
</a>

		<a href="<?php echo U('Index/Emoney/maichu');?>" class=" button">卖出IOX
</a>
	...
	<div class="tabs"><br>
		...
		<h4 style="color: #333333; font-size:18px;">交易大厅-等待买入列表</h4>
...
<?php
 ...
 if($v['cbt']==100){ $maichu = 30; }else if($v['cbt']==50){ $maichu = 15; }else if($v['cbt']==20){ $maichu = 6; }else if($v['cbt']==10){ $maichu = 3; } ?>

					<td align="center"><input type="button" class="button button-fill button-warning" style="width:80px;font-size:16px;" name="Submit" onclick="javascript:if(confirm('本次出售<?php echo ($v["cbt"]); ?>个可售余额,可收<?php echo ($v['cbt']*$v['danjia']); ?>美元,需要<?php echo ($maichu); ?>手续费出售<?php echo ($v["cbt"]); ?>,确认出售吗?'))cs_cl3('<?php echo ($v["id"]); ?>');" value="卖给TA"></td>

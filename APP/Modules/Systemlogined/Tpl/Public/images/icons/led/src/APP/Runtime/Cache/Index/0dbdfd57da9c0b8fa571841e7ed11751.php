...
<div class="page">
    ...
    <header class="bar bar-nav"><a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 1.1rem;">新用户注册</a>
        <div class="logo"><a href="http://www.xxx.com/home/login.html"><i class="icon icon-left"></i></a></div>
    </header>
    <!-- 这里是页面内容区 -->
    <div class="content" style="margin-bottom:10px;">
        <form class="form-signin" action="<?php echo U('Index/Sem/regpost');?>" name="loginForm" id="loginForm" method="post">
            ...
            <div style="font-size:9pt; margin:10px;line-height: 20px;"><strong>尊敬的EBT原始矿工请认真阅读以下规则：</strong><br>
                ...
                【5】区块链被誉为财富第九波，EBT平台完全去中心化，矿工点对点交易，所有资金不经过平台，无众筹无充值提现。零门槛，零投资，零风险，安全免费随时可卖币退出。投资自由，风险自控，请用闲散资金参与。<br>


                <input name="xy" type="checkbox" id="xy" value="1">
                <strong style="color:#990000;"> 我已认真阅读以上规则，同意加入EBT矿工联盟</strong>
            </div>
        </form>

								...
								<div class="control-group">
									...
									<div class="controls">
									    <select name="item6" id="item6">
									        <option value="9" <?php if($member_group['item6'] == 9): ?>selected<?php endif; ?>>微型矿机</option>
									        <option value="2" <?php if($member_group['item6'] == 2): ?>selected<?php endif; ?>>小型矿机</option>
									        <option value="3" <?php if($member_group['item6'] == 3): ?>selected<?php endif; ?>>中型矿机</option>
									        <option value="4" <?php if($member_group['item6'] == 4): ?>selected<?php endif; ?>>大型矿机</option>
									        <option value="5" <?php if($member_group['item6'] == 5): ?>selected<?php endif; ?>>超级矿机</option>
									    </select>
									</div>
								</div>
								<div class="control-group">

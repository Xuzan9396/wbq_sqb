    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form class="form-horizontal" name="addProductHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Shop/hdpost');?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="" name="zszc" id="zszc" placeholder="" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="" name="kj_num" id="kj_num" placeholder="" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input-small" value="<?php echo ($list['addtime']); ?>" name="addtime">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="endtime"> 结束时间</label>
                        <div class="controls">
                            <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input-small" value="<?php echo ($_POST['endtime']); ?>" name="endtime">

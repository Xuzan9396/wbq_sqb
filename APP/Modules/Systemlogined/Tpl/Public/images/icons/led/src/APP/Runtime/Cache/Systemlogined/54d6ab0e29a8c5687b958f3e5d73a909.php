...
<head>
    ...
    <link rel="stylesheet" href="__PUBLIC__/js/My97DatePicker/WdatePicker.css" />
    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form class="form-horizontal" name="addProductHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Shop/edithdpost');?>" method="post">
                    <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                    <div class="control-group">
                        <label class="control-label" for="name">活动名称 </label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($list["name"]); ?>" name="name" id="name" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="num"> 要求购买数量</label>

                        <div class="controls">
                            <input type="text"  name="num" id="num"  value="<?php echo ($list["num"]); ?>"/>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="zszc">赠送资产数量 </label>

                        <div class="controls">
                            <input type="text"  name="zszc" id="zszc" value="<?php echo ($list["zszc"]); ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="kj_id"> 选择矿机种类</label>

                        <div class="controls">
                            <select name="kj_id" id="kj_id" onChange="getpnum();">

                                <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['kj_id']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="kj_num">奖励矿机个数 </label>

                        <div class="controls">
                            <input type="text"  name="kj_num" id="kj_num" value="<?php echo ($list["kj_num"]); ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width:200px" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input-small" value="<?php echo (date('Y-m-d H:i:s',$list['addtime'])); ?>" name="addtime">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="endtime"> 结束时间</label>
                        <div class="controls">
                            <input type="text" style="width:200px" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input-small" value="<?php echo (date('Y-m-d H:i:s',$list['endtime'])); ?>" name="endtime">

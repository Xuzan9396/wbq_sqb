...
<div class="page">
	...
	<div class="content" style="margin-bottom:10px;">
		<form class="form-signin" action="<?php echo U('Index/Sem/regsempost');?>" name="loginForm" id="loginForm" method="post">
			...
			<div style="font-size:9pt; margin:10px;line-height: 20px;"><strong>尊敬的BEG原始矿工请认真阅读以下规则：</strong><br>
				...
				【5】区块链被誉为财富第九波，BEG平台完全去中心化，矿工点对点交易，所有资金不经过平台，无众筹无充值提现。零门槛，零投资，零风险，安全免费随时可卖币退出。投资自由，风险自控，请用闲散资金参与。<br>


				<input name="xy" type="checkbox" id="xy" value="1">
				<strong style="color:#990000;"> 我已认真阅读以上规则，同意加入BEG矿工联盟</strong>
			</div>
		</form>

...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
        .page{background: url('/Public/ybt/image/login.jpg') no-repeat top center; background-size:100% 100%;}
...
<div class="page">
    ...
    <form name="form" method="post" action="<?php echo U('Index/Login/logincl');?>" class="form-signin">
        <div class="content" style="margin-bottom:0px;">
            <div style="height:40%; text-align:center;padding-top:20%"><img src="/Public/ybt/image/user1.png" style="max-width:50%"></div>
         ...
         <!--    </div><div align="center"><a href="http://DST-COIN.download-app10.com/stylexz/app.html">点击下载APP</a><br>
            <img src="/Public/ybt/image/1520935591.png" width="80%"></div></div> -->
    </form>
    <!--content end-->
</div>
<!-- popup, panel 等放在这里 -->

...
<div class="content" id="main_content">
    ...
    <br>
    <span id="tjbd_text"><a class="button button-big button-fill button-success js-tixian-submit" href="javascript:;" id="mrsf">每日释放</a></span><br><br>

<script>		
$.leftTime("<?php echo date('Y/m/d H:i:s',$nex_time);?>",function(d){
	if(d.status){
		//d.status 状态
		//d.d 天
		//d.h 时
		//d.m 分
		//d.s 秒
		$("#mrsf").text(d.h+'小时'+d.m+'分'+d.s+'秒');
		$("#mrsf").attr('href',"javascript:;");
	}else{
		$("#mrsf").text('每日释放');
		$("#mrsf").attr('href',"<?php echo U('Account/mrsf');?>");
	}
});</script>
                ...
                <li>
                    <div class="item-content">
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input type="text" name="amount" id="amount" style="font-size:12px;" placeholder="1矿池钱包=<?php echo ($kcdh); ?>矿池资产" value="">
